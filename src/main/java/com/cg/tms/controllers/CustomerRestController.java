...
public class CustomerRestController {
	...
	public String addCustomer(@RequestBody CreateCustomerRequest requestData) {
		...
		return "added package with packageId =" + added.getCustomerId();
	}

	@DeleteMapping("/deleteCustomer")
	public void deleteCustomer(@RequestBody DeleteCustomerRequest requestData) {

		customerService.deleteCustomer(requestData.getCustomer());
	}
